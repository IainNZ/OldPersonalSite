...
[JuMP](http://github.com/JuliaOpt/JuMP.jl) is an algebraic modeling language for optimization problems implemented as a package for the [Julia](http://julialang.org) programming language. It works with many solvers, both open-source and commercial - see the [JuliaOpt](http://juliaopt.org) home page for more information. I've written [a](http://localhost:4000/2013/urban-planning.html) [few](http://localhost:4000/2013/combination-locks.html) [times](http://localhost:4000/2013/sudoku-as-a-service.html) about solving problems with JuMP.
